...
from opwen_email_server.integration.celery import process_echo_service_email

receive_echo_service_email = ReceiveInboundEmail(
    auth=get_no_auth(),
    raw_email_storage=get_raw_email_storage(),
    next_task=process_echo_service_email,
)

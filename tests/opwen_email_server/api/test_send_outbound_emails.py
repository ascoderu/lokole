...
class SendOutboundEmailsTests(TestCase):
    ...
    @patch.object(send_outbound_emails, 'EMAIL')
    def test_reads_message_and_stores_email(self, email_mock, fetch_mock):
        ...
        email_mock.send_email.assert_called_once_with(email)
